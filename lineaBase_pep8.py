...
def lineaBase(org):
    ...
    for conj in range(conjuntos.index(org), len(conjuntos)):
        # Escribir conjunto -> Tab -> "Ap" -> Tab -> C -> Click en ejecutar *2
        # -> Click en donde se pone el nombre
        ...
        if conj == 0 or conj == conjuntos.index(org):
            ...
            paste()
        pyautogui.typewrite(['tab'])
        pyautogui.moveTo(540, 615, 0.2)
        pyautogui.click(clicks=2, interval=0.2)
        pyautogui.moveTo(220, 210, 0.2)
        pyautogui.click()
...
# Opción viable: Detectar posiciones de los clicks una sola vez al inicio
# del script
'''#Lista de conjuntos
